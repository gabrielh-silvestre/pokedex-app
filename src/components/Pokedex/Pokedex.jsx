...
export default class Container extends Component {
  ...
  render() {
    ...
    return (
      <article className="px-4 sm:grid sm:grid-cols-2 sm:gap-4 lg:grid-cols-3 lg:px-24 xl:w-4/5 xl:mx-auto 2xl:grid-cols-4">
        {savedPokemons
          .sort((a, b) => a.id - b.id)
          .map((pokemon) => this.renderPokeCard(pokemon))}

        <div className="flex justify-center pb-8 sm:col-span-full">
